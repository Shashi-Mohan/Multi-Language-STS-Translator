...
Receives the English audio file.

Transcribes the spoken English into text.

Translates the English text into multiple target languages.

Converts every translated sentence into natural-sounding speech.

Shows the translated text and provides audio playback through the Streamlit interface.
...
Translation from English into target languages

ElevenLabs

Text-to-Speech and natural voice generation

tempfile

Temporary handling of uploaded audio
...
Creating unique names for generated audio files
...
Development environment used in the project
